...
const movie_controller_1 = require("../../controllers/api/movie.controller");
const MovieImageUpload_1 = __importDefault(require("../../helper/MovieImageUpload"));
...
movieRouter.post('/create-movie', (0, VerifyUserRoleToken_1.verifyUserRoleToken)(["admin"]), MovieImageUpload_1.default.single('movieImage'), movie_controller_1.movieController.createMovie);
/**
 * @swagger
 * /movie/get-movies:
 *   get:
...
movieRouter.get('/get-movies', (0, VerifyUserRoleToken_1.verifyUserRoleToken)(["user", "admin"]), movie_controller_1.movieController.getAllMovies);
/**
 * @swagger
...
movieRouter.get('/get-movie/:movieId', (0, VerifyUserRoleToken_1.verifyUserRoleToken)(["user", "admin"]), movie_controller_1.movieController.getMovieById);
